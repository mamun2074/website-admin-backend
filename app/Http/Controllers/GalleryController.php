...
//    Important Variable
    ...
    public $parentModel = Gallery::class;

    public $parentRoute = 'gallery';
    public $parentView = "admin.gallery";
    ...
    public function store(Request $request)
    {
        ...
        $featured->move('upload/gallery', $featured_new_name);

        $this->parentModel::create([
            'thumbnail' => "upload/gallery/" . $featured_new_name,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('thumbnail')) {
            ...
            $featured_new_name = time() . $featured->getClientOriginalName();
            $featured->move('upload/gallery', $featured_new_name);
            $item->featured= 'upload/gallery/'.$featured_new_name;
        }
        $item->save();
