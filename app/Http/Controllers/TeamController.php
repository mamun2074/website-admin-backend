...
//    Important Variable
    ...
    public $parentModel = Team::class;

    public $parentRoute = 'team';
    public $parentView = "admin.team";
    ...
    public function store(Request $request)
    {
        ...
        $featured = $request->thumbnail;
        $featured_new_name = time() . $featured->getClientOriginalName();
        $featured->move('upload/team', $featured_new_name);

        $this->parentModel::create([
            'name' => $request->name,
            'designation' => $request->designation,
            'team_content' => $request->team_content,
            'thumbnail' => "upload/team/" . $featured_new_name,
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('thumbnail')) {
            ...
            $featured_new_name = time() . $featured->getClientOriginalName();
            $featured->move('upload/team', $featured_new_name);
            $item->featured= 'upload/team/'.$featured_new_name;
        }

        $item->name=$request->name;
        $item->designation=$request->designation;
        $item->team_content=$request->team_content;
