...
//    Important Variable
    ...
    public $parentModel = Service::class;

    public $parentRoute = 'service';
    public $parentView = "admin.service";
    ...
    public function update(Request $request, $id)
    {
        ...
        $item->service_category_id=$request->service_category_id;
        $item->service_content=$request->service_content;
