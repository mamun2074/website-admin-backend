    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route($ParentRouteName) }}"><i class="material-icons">library_add</i>{{  $breadcrumbMainName }}</a>
                </li>
                <li class="active"><i
...
@push('include-js')
    ...
    <script>
        ...
        // Validation and calculation on Catageory
        var UiController = (function () {
            ...
            return {
                ...
                getInputsValue: function () {
                    ...
                    return {
                        name: Fields.get_name.value == "" ? 0 : parseFloat(Fields.get_name.value),
