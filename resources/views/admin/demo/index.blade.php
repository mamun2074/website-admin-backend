...
$breadcrumbMainIcon = " fas fa-sliders-h";  // Font Awesome
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        @foreach($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ App\InitialHeadBalance::find($item->id)->project->name }}</td>


                                                <td>{{ App\InitialHeadBalance::find($item->id)->HeadOfAccount->name }}</td>

                                                <td>{{ date('M, d Y', strtotime($item->date)) }}</td>
                                                <td class="text-right">{{ number_format( $item->amount , 2) }}</td>
                                                <td class="text-center">{{ str_pad( $item->id, 4, '0', STR_PAD_LEFT) }}</td>

                                                <td>

                                                    @if (  App\InitialHeadBalance::find($item->id)->confirm == 1 )
