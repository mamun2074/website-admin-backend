...
$breadcrumbMainIcon = " fas fa-newspaper";  // Font Awesome
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        @foreach($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ App\User::find($item->author_id)->name  }}</td>
                                                <td><img style="width: 50px; height: 50px" src="{{ asset($item->featured)  }}" alt="{{ $item->title  }}"></td>
