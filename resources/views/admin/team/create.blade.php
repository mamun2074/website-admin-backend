...
$breadcrumbMainIcon = " fas fa-users";
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <input id="Designation" placeholder="Designation" type="text" name="designation" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <input placeholder="Facebook "  id="Facebook" type="text" name="facebook" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <input   placeholder="Twitter"  id="twitter" type="text" name="twitter" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <input placeholder="Linked In"  id="linkedin" type="text" name="linkedin" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <input  placeholder="Youtube"   id="youtube" type="text" name="youtube" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <textarea cols="5" rows="50" placeholder="Pots content here" class="form-control" name="team_content"
        ...
        var MainController = (function (UICnt) {
            ...
            var validation = function (e) {
                ...
                if (Values.thumbnail == 0) {
                    toastr["error"]('Thumbnail field should not empty');
                    e.preventDefault();
                }
