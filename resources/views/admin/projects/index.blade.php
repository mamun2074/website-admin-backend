    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header pull-left">
                @if ( \Request::route()->getName() == 'project.search' )
                    <a class="btn btn-sm btn-info" href="{{ route('projects') }}">Back</a>
                @endif
                <a class="btn btn-sm btn-success" href="{{ route('project.create') }}">Add Project</a>

            </div>
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                <li><a href="{{ route('dashboard') }}"><i class="material-icons">home</i> Home</a></li>
                <li class="active"><i class="material-icons">library_add</i> Project</li>
            </ol>
            <!-- Hover Rows -->
            <div class="row">
                        ...
                        <div class="card">
                            <div class="header">
                                <a class="btn btn-xs btn-success"
                                   href="{{ route('projects')  }}">All({{ App\Project::all()->count() }})</a>
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <form class="search" action="{{ route('project.active.search') }}" method="get">
                                        {{ csrf_field() }}
                            ...
                            <form class="actionForm" action="{{ route('project.active.action') }}" method="get">
                                ...
                                <div class="body table-responsive">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @foreach($projects as $project)
                                            <tr>
                                                <th>
                                                    <input name="project[project_id][]" value="{{ $project->id }}"
                                                ...
                                                <td> @if ($project->hand_over_date)
                                                        {{ date("M-Y", strtotime($project->hand_over_date)) }}
                                                    @endif </td>
