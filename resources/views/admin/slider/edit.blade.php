                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->title  }}" placeholder="Title" name="title" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea  name="description" rows="2" class="form-control no-resize"
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <img style="width: 100px; height: 100px;" src="{{ asset($item->link)  }}" alt="">
                                            </div>
                                        </div>
            ...
            return {
                ...
                getFields: function () {
                    return {
                        ...
                        get_link: document.querySelector(DOMString.link),
                ...
                getInputsValue: function () {
                    ...
                    return {
                        link: Fields.get_link.value == "" ? 0 : Fields.get_link.value,
